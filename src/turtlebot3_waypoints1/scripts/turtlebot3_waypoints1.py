...
class WaypointHandlerNode:
    ...
    def __init__(self):
        ...
        #[-2,0],[0,-2],[-1.6, -1.1],[-2 ,0],[-1.8, -1.2], [0.77, -0.67], [0.57, 0.76], [-1.57, 1.37],[-1.8, -1.2], [0.77, -0.67], [0.57, 0.76], [-1.57, 1.37]
        self.wpts = [[-1.8, -1.2],[-2,0],[0,-2],[-1.6, -1.1],[-2 ,0],[-1.8, -1.2], [1.8, 1.2], [0.57, 0.76], [-1.57, 1.37],[-1.8, -1.2], [0.77, -0.67], [0.57, 0.76], [-1.57, 1.37],[-2,0],[0,-2],[-1.6, -1.1],[-2 ,0],[-1.8, -1.2], [0.77, -0.67], [0.57, 0.76], [-1.57, 1.37],[-1.8, -1.2], [0.77, -0.67], [1.8, 0.76], [-1.57, 1.37]]
        #this are my waypoints that the robot must go
        #trajectory 1 = [[-1.8, -1.2], [-0.55, -0.67]]
        #trajectory 2 = [[-1.8, -1.2], [-0.1, -0.1]]
